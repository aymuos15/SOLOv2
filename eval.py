...
def eval(valmodel_weight, data_path, benchmark, test_mode, save_imgs=False):
    ...
    if test_mode == "images":
        ...
        for imgpath in images:
            ...
            #cv.imshow("watch windows",img_show)
            #cv.waitKey(1)
            out_filepath = "/home/soumya/SOLOv2/results/" + os.path.basename(imgpath)

            k = k + 1
            if save_imgs:
                print("save image: ", out_filepath)
...
# eval(valmodel_weight='pretrained/solov2_448_r18_epoch_36.pth',data_path="data/casia-SPT_val/val/JPEGImages", benchmark=False, test_mode="images", save_imgs=True)
eval(valmodel_weight='/home/soumya/SOLOv2/weights/solov2_resnet18_epoch_1.pth',data_path="/home/soumya/SOLOv2/data/casia-SPT_val/val/JPEGImages", benchmark=False, test_mode="images", save_imgs=True)
